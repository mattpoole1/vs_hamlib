...
class hamlib_port_t_parm(_object):
    ...
    __swig_getmethods__["cm108"] = _Hamlib.hamlib_port_t_parm_cm108_get
    if _newclass:cm108 = _swig_property(_Hamlib.hamlib_port_t_parm_cm108_get)
    ...
    def __init__(self): 
        this = _Hamlib.new_hamlib_port_t_parm()
        try: self.this.append(this)
        except: self.this = this
...
class hamlib_port_t_parm_usb(_object):
    ...
    __swig_setmethods__["vendor_name"] = _Hamlib.hamlib_port_t_parm_usb_vendor_name_set
    __swig_getmethods__["vendor_name"] = _Hamlib.hamlib_port_t_parm_usb_vendor_name_get
    if _newclass:vendor_name = _swig_property(_Hamlib.hamlib_port_t_parm_usb_vendor_name_get, _Hamlib.hamlib_port_t_parm_usb_vendor_name_set)
    __swig_setmethods__["product"] = _Hamlib.hamlib_port_t_parm_usb_product_set
    __swig_getmethods__["product"] = _Hamlib.hamlib_port_t_parm_usb_product_get
    if _newclass:product = _swig_property(_Hamlib.hamlib_port_t_parm_usb_product_get, _Hamlib.hamlib_port_t_parm_usb_product_set)
    def __init__(self): 
        this = _Hamlib.new_hamlib_port_t_parm_usb()
        try: self.this.append(this)
        except: self.this = this
...
class hamlib_port_t_parm_cm108(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, hamlib_port_t_parm_cm108, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, hamlib_port_t_parm_cm108, name)
    __repr__ = _swig_repr
    __swig_setmethods__["ptt_bitnum"] = _Hamlib.hamlib_port_t_parm_cm108_ptt_bitnum_set
    __swig_getmethods__["ptt_bitnum"] = _Hamlib.hamlib_port_t_parm_cm108_ptt_bitnum_get
    if _newclass:ptt_bitnum = _swig_property(_Hamlib.hamlib_port_t_parm_cm108_ptt_bitnum_get, _Hamlib.hamlib_port_t_parm_cm108_ptt_bitnum_set)
    def __init__(self): 
        this = _Hamlib.new_hamlib_port_t_parm_cm108()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _Hamlib.delete_hamlib_port_t_parm_cm108
    __del__ = lambda self : None;
hamlib_port_t_parm_cm108_swigregister = _Hamlib.hamlib_port_t_parm_cm108_swigregister
hamlib_port_t_parm_cm108_swigregister(hamlib_port_t_parm_cm108)
...
class hamlib_port_t_parm_parallel(_object):
    ...
    def __init__(self): 
        this = _Hamlib.new_hamlib_port_t_parm_parallel()
        try: self.this.append(this)
        except: self.this = this
...
class hamlib_port_t_parm_serial(_object):
    ...
    def __init__(self): 
        this = _Hamlib.new_hamlib_port_t_parm_serial()
        try: self.this.append(this)
        except: self.this = this
...
class hamlib_port_t_post_write_date(_object):
    ...
    def __init__(self): 
        this = _Hamlib.new_hamlib_port_t_post_write_date()
        try: self.this.append(this)
        except: self.this = this
...
class hamlib_port_t_type(_object):
    ...
    def __init__(self): 
        this = _Hamlib.new_hamlib_port_t_type()
        try: self.this.append(this)
        except: self.this = this
...
class rig_state(_object):
    ...
    if _newclass:tx_vfo = _swig_property(_Hamlib.rig_state_tx_vfo_get, _Hamlib.rig_state_tx_vfo_set)
    ...
    if _newclass:mode_list = _swig_property(_Hamlib.rig_state_mode_list_get, _Hamlib.rig_state_mode_list_set)
    def __init__(self): 
...
def rig_init(*args):
  return _Hamlib.rig_init(*args)
rig_init = _Hamlib.rig_init

def rig_set_split_vfo(*args):
  return _Hamlib.rig_set_split_vfo(*args)
rig_set_split_vfo = _Hamlib.rig_set_split_vfo

def rig_get_split_vfo(*args):
  return _Hamlib.rig_get_split_vfo(*args)
rig_get_split_vfo = _Hamlib.rig_get_split_vfo

def rig_ext_lookup(*args):
  return _Hamlib.rig_ext_lookup(*args)
rig_ext_lookup = _Hamlib.rig_ext_lookup

def rig_ext_lookup_tok(*args):
  return _Hamlib.rig_ext_lookup_tok(*args)
rig_ext_lookup_tok = _Hamlib.rig_ext_lookup_tok

def rig_ext_token_lookup(*args):
  return _Hamlib.rig_ext_token_lookup(*args)
rig_ext_token_lookup = _Hamlib.rig_ext_token_lookup

def rig_token_foreach(*args):
  return _Hamlib.rig_token_foreach(*args)
rig_token_foreach = _Hamlib.rig_token_foreach

def rig_confparam_lookup(*args):
  return _Hamlib.rig_confparam_lookup(*args)
rig_confparam_lookup = _Hamlib.rig_confparam_lookup

def rig_set_chan_all(*args):
  return _Hamlib.rig_set_chan_all(*args)
rig_set_chan_all = _Hamlib.rig_set_chan_all

def rig_get_chan_all(*args):
  return _Hamlib.rig_get_chan_all(*args)
rig_get_chan_all = _Hamlib.rig_get_chan_all

def rig_set_chan_all_cb(*args):
  return _Hamlib.rig_set_chan_all_cb(*args)
rig_set_chan_all_cb = _Hamlib.rig_set_chan_all_cb

def rig_get_chan_all_cb(*args):
  return _Hamlib.rig_get_chan_all_cb(*args)
rig_get_chan_all_cb = _Hamlib.rig_get_chan_all_cb

def rig_set_mem_all_cb(*args):
  return _Hamlib.rig_set_mem_all_cb(*args)
rig_set_mem_all_cb = _Hamlib.rig_set_mem_all_cb

def rig_get_mem_all_cb(*args):
  return _Hamlib.rig_get_mem_all_cb(*args)
rig_get_mem_all_cb = _Hamlib.rig_get_mem_all_cb

def rig_set_mem_all(*args):
  return _Hamlib.rig_set_mem_all(*args)
rig_set_mem_all = _Hamlib.rig_set_mem_all

def rig_get_mem_all(*args):
  return _Hamlib.rig_get_mem_all(*args)
rig_get_mem_all = _Hamlib.rig_get_mem_all

def rig_lookup_mem_caps(*args):
  return _Hamlib.rig_lookup_mem_caps(*args)
rig_lookup_mem_caps = _Hamlib.rig_lookup_mem_caps

def rig_mem_count(*args):
  return _Hamlib.rig_mem_count(*args)
rig_mem_count = _Hamlib.rig_mem_count

def rig_get_caps(*args):
  return _Hamlib.rig_get_caps(*args)
rig_get_caps = _Hamlib.rig_get_caps

def rig_get_range(*args):
  return _Hamlib.rig_get_range(*args)
rig_get_range = _Hamlib.rig_get_range

def rigerror(*args):
  return _Hamlib.rigerror(*args)
rigerror = _Hamlib.rigerror

def rig_setting2idx(*args):
  return _Hamlib.rig_setting2idx(*args)
rig_setting2idx = _Hamlib.rig_setting2idx

def rig_set_debug(*args):
  return _Hamlib.rig_set_debug(*args)
rig_set_debug = _Hamlib.rig_set_debug

def rig_need_debug(*args):
  return _Hamlib.rig_need_debug(*args)
...
def rig_set_debug_callback(*args):
  return _Hamlib.rig_set_debug_callback(*args)
rig_set_debug_callback = _Hamlib.rig_set_debug_callback

def rig_set_debug_file(*args):
  return _Hamlib.rig_set_debug_file(*args)
rig_set_debug_file = _Hamlib.rig_set_debug_file

def rig_register(*args):
  return _Hamlib.rig_register(*args)
rig_register = _Hamlib.rig_register

def rig_unregister(*args):
  return _Hamlib.rig_unregister(*args)
rig_unregister = _Hamlib.rig_unregister

def rig_list_foreach(*args):
  return _Hamlib.rig_list_foreach(*args)
rig_list_foreach = _Hamlib.rig_list_foreach

def rig_load_backend(*args):
  return _Hamlib.rig_load_backend(*args)
rig_load_backend = _Hamlib.rig_load_backend

def rig_check_backend(*args):
  return _Hamlib.rig_check_backend(*args)
...
def rig_probe_all(*args):
  return _Hamlib.rig_probe_all(*args)
rig_probe_all = _Hamlib.rig_probe_all

def rig_strrmode(*args):
  return _Hamlib.rig_strrmode(*args)
rig_strrmode = _Hamlib.rig_strrmode

def rig_strvfo(*args):
  return _Hamlib.rig_strvfo(*args)
rig_strvfo = _Hamlib.rig_strvfo

def rig_strfunc(*args):
  return _Hamlib.rig_strfunc(*args)
rig_strfunc = _Hamlib.rig_strfunc

def rig_strlevel(*args):
  return _Hamlib.rig_strlevel(*args)
rig_strlevel = _Hamlib.rig_strlevel

def rig_strparm(*args):
  return _Hamlib.rig_strparm(*args)
rig_strparm = _Hamlib.rig_strparm

def rig_strptrshift(*args):
  return _Hamlib.rig_strptrshift(*args)
rig_strptrshift = _Hamlib.rig_strptrshift

def rig_strvfop(*args):
  return _Hamlib.rig_strvfop(*args)
rig_strvfop = _Hamlib.rig_strvfop

def rig_strscan(*args):
  return _Hamlib.rig_strscan(*args)
rig_strscan = _Hamlib.rig_strscan

def rig_strstatus(*args):
  return _Hamlib.rig_strstatus(*args)
rig_strstatus = _Hamlib.rig_strstatus

def rig_strmtype(*args):
  return _Hamlib.rig_strmtype(*args)
rig_strmtype = _Hamlib.rig_strmtype

def rig_parse_mode(*args):
  return _Hamlib.rig_parse_mode(*args)
rig_parse_mode = _Hamlib.rig_parse_mode

def rig_parse_vfo(*args):
  return _Hamlib.rig_parse_vfo(*args)
rig_parse_vfo = _Hamlib.rig_parse_vfo

def rig_parse_func(*args):
  return _Hamlib.rig_parse_func(*args)
rig_parse_func = _Hamlib.rig_parse_func

def rig_parse_level(*args):
  return _Hamlib.rig_parse_level(*args)
rig_parse_level = _Hamlib.rig_parse_level

def rig_parse_parm(*args):
  return _Hamlib.rig_parse_parm(*args)
rig_parse_parm = _Hamlib.rig_parse_parm

def rig_parse_vfo_op(*args):
  return _Hamlib.rig_parse_vfo_op(*args)
rig_parse_vfo_op = _Hamlib.rig_parse_vfo_op

def rig_parse_scan(*args):
  return _Hamlib.rig_parse_scan(*args)
rig_parse_scan = _Hamlib.rig_parse_scan

def rig_parse_rptr_shift(*args):
  return _Hamlib.rig_parse_rptr_shift(*args)
rig_parse_rptr_shift = _Hamlib.rig_parse_rptr_shift

def rig_parse_mtype(*args):
  return _Hamlib.rig_parse_mtype(*args)
...
def rot_init(*args):
  return _Hamlib.rot_init(*args)
rot_init = _Hamlib.rot_init

def rot_register(*args):
  return _Hamlib.rot_register(*args)
rot_register = _Hamlib.rot_register

def rot_unregister(*args):
  return _Hamlib.rot_unregister(*args)
rot_unregister = _Hamlib.rot_unregister

def rot_list_foreach(*args):
  return _Hamlib.rot_list_foreach(*args)
rot_list_foreach = _Hamlib.rot_list_foreach

def rot_load_backend(*args):
  return _Hamlib.rot_load_backend(*args)
rot_load_backend = _Hamlib.rot_load_backend

def rot_check_backend(*args):
  return _Hamlib.rot_check_backend(*args)
...
def rot_probe_all(*args):
  return _Hamlib.rot_probe_all(*args)
rot_probe_all = _Hamlib.rot_probe_all

def rot_token_foreach(*args):
  return _Hamlib.rot_token_foreach(*args)
rot_token_foreach = _Hamlib.rot_token_foreach

def rot_confparam_lookup(*args):
  return _Hamlib.rot_confparam_lookup(*args)
rot_confparam_lookup = _Hamlib.rot_confparam_lookup

def rot_token_lookup(*args):
  return _Hamlib.rot_token_lookup(*args)
...
def qrb(*args):
  return _Hamlib.qrb(*args)
qrb = _Hamlib.qrb

def distance_long_path(*args):
  return _Hamlib.distance_long_path(*args)
distance_long_path = _Hamlib.distance_long_path

def azimuth_long_path(*args):
  return _Hamlib.azimuth_long_path(*args)
azimuth_long_path = _Hamlib.azimuth_long_path

def longlat2locator(*args):
  return _Hamlib.longlat2locator(*args)
longlat2locator = _Hamlib.longlat2locator

def locator2longlat(*args):
  return _Hamlib.locator2longlat(*args)
...
def dec2dms(*args):
  return _Hamlib.dec2dms(*args)
dec2dms = _Hamlib.dec2dms

def dec2dmmm(*args):
  return _Hamlib.dec2dmmm(*args)
...
class Rig(_object):
    ...
    __swig_destroy__ = _Hamlib.delete_Rig
    __del__ = lambda self : None;
    def open(self): return _Hamlib.Rig_open(self)
    def close(self): return _Hamlib.Rig_close(self)
    def set_freq(self, *args): return _Hamlib.Rig_set_freq(self, *args)
    def set_mode(self, *args): return _Hamlib.Rig_set_mode(self, *args)
    def set_ptt(self, *args): return _Hamlib.Rig_set_ptt(self, *args)
    def set_rptr_shift(self, *args): return _Hamlib.Rig_set_rptr_shift(self, *args)
    def set_rptr_offs(self, *args): return _Hamlib.Rig_set_rptr_offs(self, *args)
    def set_ctcss_tone(self, *args): return _Hamlib.Rig_set_ctcss_tone(self, *args)
    def set_dcs_code(self, *args): return _Hamlib.Rig_set_dcs_code(self, *args)
    def set_ctcss_sql(self, *args): return _Hamlib.Rig_set_ctcss_sql(self, *args)
    def set_dcs_sql(self, *args): return _Hamlib.Rig_set_dcs_sql(self, *args)
    def set_split_freq(self, *args): return _Hamlib.Rig_set_split_freq(self, *args)
    def set_split_mode(self, *args): return _Hamlib.Rig_set_split_mode(self, *args)
    def set_split_vfo(self, *args): return _Hamlib.Rig_set_split_vfo(self, *args)
    def set_rit(self, *args): return _Hamlib.Rig_set_rit(self, *args)
    def set_xit(self, *args): return _Hamlib.Rig_set_xit(self, *args)
    def set_ts(self, *args): return _Hamlib.Rig_set_ts(self, *args)
    def set_ant(self, *args): return _Hamlib.Rig_set_ant(self, *args)
    def set_func(self, *args): return _Hamlib.Rig_set_func(self, *args)
    def set_bank(self, *args): return _Hamlib.Rig_set_bank(self, *args)
    def set_mem(self, *args): return _Hamlib.Rig_set_mem(self, *args)
    def send_dtmf(self, *args): return _Hamlib.Rig_send_dtmf(self, *args)
    def send_morse(self, *args): return _Hamlib.Rig_send_morse(self, *args)
    def vfo_op(self, *args): return _Hamlib.Rig_vfo_op(self, *args)
    def scan(self, *args): return _Hamlib.Rig_scan(self, *args)
    def set_level(self, *args): return _Hamlib.Rig_set_level(self, *args)
    def set_ext_level(self, *args): return _Hamlib.Rig_set_ext_level(self, *args)
    def get_level_i(self, *args): return _Hamlib.Rig_get_level_i(self, *args)
    def get_level_f(self, *args): return _Hamlib.Rig_get_level_f(self, *args)
    def set_vfo(self, *args): return _Hamlib.Rig_set_vfo(self, *args)
    def set_powerstat(self, *args): return _Hamlib.Rig_set_powerstat(self, *args)
    def set_trn(self, *args): return _Hamlib.Rig_set_trn(self, *args)
    def has_set_level(self, *args): return _Hamlib.Rig_has_set_level(self, *args)
    def has_set_parm(self, *args): return _Hamlib.Rig_has_set_parm(self, *args)
    def has_set_func(self, *args): return _Hamlib.Rig_has_set_func(self, *args)
    def reset(self, *args): return _Hamlib.Rig_reset(self, *args)
    def has_scan(self, *args): return _Hamlib.Rig_has_scan(self, *args)
    def has_vfo_op(self, *args): return _Hamlib.Rig_has_vfo_op(self, *args)
    def passband_normal(self, *args): return _Hamlib.Rig_passband_normal(self, *args)
    def passband_narrow(self, *args): return _Hamlib.Rig_passband_narrow(self, *args)
    def passband_wide(self, *args): return _Hamlib.Rig_passband_wide(self, *args)
    def ext_token_lookup(self, *args): return _Hamlib.Rig_ext_token_lookup(self, *args)
    def token_lookup(self, *args): return _Hamlib.Rig_token_lookup(self, *args)
    def set_ext_parm(self, *args): return _Hamlib.Rig_set_ext_parm(self, *args)
    def set_parm(self, *args): return _Hamlib.Rig_set_parm(self, *args)
    def get_parm_i(self, *args): return _Hamlib.Rig_get_parm_i(self, *args)
    def get_parm_f(self, *args): return _Hamlib.Rig_get_parm_f(self, *args)
    def get_parm(self, *args): return _Hamlib.Rig_get_parm(self, *args)
    def set_conf(self, *args): return _Hamlib.Rig_set_conf(self, *args)
    def get_freq(self, *args): return _Hamlib.Rig_get_freq(self, *args)
    def get_mode(self, *args): return _Hamlib.Rig_get_mode(self, *args)
    def get_split_mode(self, *args): return _Hamlib.Rig_get_split_mode(self, *args)
    def get_vfo(self, *args): return _Hamlib.Rig_get_vfo(self, *args)
    def get_ptt(self, *args): return _Hamlib.Rig_get_ptt(self, *args)
    def get_rptr_shift(self, *args): return _Hamlib.Rig_get_rptr_shift(self, *args)
    def get_rptr_offs(self, *args): return _Hamlib.Rig_get_rptr_offs(self, *args)
    def get_ctcss_tone(self, *args): return _Hamlib.Rig_get_ctcss_tone(self, *args)
    def get_dcs_code(self, *args): return _Hamlib.Rig_get_dcs_code(self, *args)
    def get_ctcss_sql(self, *args): return _Hamlib.Rig_get_ctcss_sql(self, *args)
    def get_dcs_sql(self, *args): return _Hamlib.Rig_get_dcs_sql(self, *args)
    def get_split_freq(self, *args): return _Hamlib.Rig_get_split_freq(self, *args)
    def get_split_vfo(self, *args): return _Hamlib.Rig_get_split_vfo(self, *args)
    def get_rit(self, *args): return _Hamlib.Rig_get_rit(self, *args)
    def get_xit(self, *args): return _Hamlib.Rig_get_xit(self, *args)
    def get_ts(self, *args): return _Hamlib.Rig_get_ts(self, *args)
    def get_ant(self, *args): return _Hamlib.Rig_get_ant(self, *args)
    def get_mem(self, *args): return _Hamlib.Rig_get_mem(self, *args)
    def get_powerstat(self, *args): return _Hamlib.Rig_get_powerstat(self, *args)
    def get_trn(self, *args): return _Hamlib.Rig_get_trn(self, *args)
    def mem_count(self, *args): return _Hamlib.Rig_mem_count(self, *args)
    def lookup_mem_caps(self, *args): return _Hamlib.Rig_lookup_mem_caps(self, *args)
    def set_channel(self, *args): return _Hamlib.Rig_set_channel(self, *args)
    def chan_clear(self, *args): return _Hamlib.Rig_chan_clear(self, *args)
    def get_chan_all(self, *args): return _Hamlib.Rig_get_chan_all(self, *args)
    def get_channel(self, *args): return _Hamlib.Rig_get_channel(self, *args)
    def get_conf(self, *args): return _Hamlib.Rig_get_conf(self, *args)
    def recv_dtmf(self, *args): return _Hamlib.Rig_recv_dtmf(self, *args)
    def get_info(self, *args): return _Hamlib.Rig_get_info(self, *args)
    def get_func(self, *args): return _Hamlib.Rig_get_func(self, *args)
    def get_level(self, *args): return _Hamlib.Rig_get_level(self, *args)
Rig_swigregister = _Hamlib.Rig_swigregister
Rig_swigregister(Rig)
...
class channelArray(_object):
    ...
    __del__ = lambda self : None;
    def __getitem__(self, *args): return _Hamlib.channelArray___getitem__(self, *args)
    def __setitem__(self, *args): return _Hamlib.channelArray___setitem__(self, *args)
    def cast(self): return _Hamlib.channelArray_cast(self)
...
def channelArray_frompointer(*args):
  return _Hamlib.channelArray_frompointer(*args)
...
class toneArray(_object):
    ...
    __del__ = lambda self : None;
    def __getitem__(self, *args): return _Hamlib.toneArray___getitem__(self, *args)
    def __setitem__(self, *args): return _Hamlib.toneArray___setitem__(self, *args)
    def cast(self): return _Hamlib.toneArray_cast(self)
...
def toneArray_frompointer(*args):
  return _Hamlib.toneArray_frompointer(*args)
...
class Rot(_object):
    ...
    __swig_destroy__ = _Hamlib.delete_Rot
    __del__ = lambda self : None;
    def open(self): return _Hamlib.Rot_open(self)
    def close(self): return _Hamlib.Rot_close(self)
    def set_position(self, *args): return _Hamlib.Rot_set_position(self, *args)
    def get_position(self): return _Hamlib.Rot_get_position(self)
    def stop(self): return _Hamlib.Rot_stop(self)
    def park(self): return _Hamlib.Rot_park(self)
    def reset(self, *args): return _Hamlib.Rot_reset(self, *args)
    def move(self, *args): return _Hamlib.Rot_move(self, *args)
    def token_lookup(self, *args): return _Hamlib.Rot_token_lookup(self, *args)
    def set_conf(self, *args): return _Hamlib.Rot_set_conf(self, *args)
    def get_conf(self, *args): return _Hamlib.Rot_get_conf(self, *args)
    def get_info(self, *args): return _Hamlib.Rot_get_info(self, *args)
Rot_swigregister = _Hamlib.Rot_swigregister
Rot_swigregister(Rot)
